$(document).ready(function(){
  ...
  $.getJSON('model/data.json', function(jsonObj) {
    ...
    $('#subTitle_coke').html('<h4>' + jsonObj.pageTextData[4].subTitle + '</h3>');
    $('#description_coke').html('<p>' + jsonObj.pageTextData[4].description + '</p>');
    $('.card-text').html('<p>' + jsonObj.pageTextData[4].gallery + '</p>');    
    $('.card-title').html('<p>' + jsonObj.pageTextData[4].gallery + '</p>');    
